...
class Schedule(models.Model):
    ...
    def __str__(self):
        return str(self.station)+" arriving at "+str(self.arrival)+" departing at "+str(self.departure)
...
class Ticket(models.Model):
    ...
    board = models.ForeignKey(Station, on_delete=models.CASCADE, related_name="board_tickets")
    board_schedule = models.ForeignKey(Schedule, on_delete=models.CASCADE, related_name="board_schedule_tickets" )
